...
class BRepNetExtractor:
    ...
    def extract_features_from_edge(self, edge, faces):
        ...
        for feature in feature_list:
            if feature == "Concave edge":
                edge_features.append(self.convexity_feature(convexity, feature)) # type: ignore
    ...
    def extract_face_point_grids(self, body, entity_mapper):
        ...
        for face in solid.faces(): # type: ignore
    ...
    def extract_face_point_grid(self, face):
        ...
        single_grid = np.concatenate([points, normals, mask], axis=2)  # type: ignore
    ...
    def extract_coedge_point_grids(self, body, entity_mapper):
        ...
        for wire in top_exp.wires():
            ...
            for coedge in wire_exp.ordered_edges():
                ...
                faces = [ f for f in solid.faces_from_edge(occwl_oriented_edge) ]  # type: ignore
        ...
        if scale_from_faces:
            ...
            for i in range(num_coedges):
                ...
                for coedge_index in coedges:
                    ...
                    num_u = 10
                    assert points_from_coedges.shape[0] == 3  # type: ignore
                    assert points_from_coedges.shape[1] == num_u  # type: ignore
